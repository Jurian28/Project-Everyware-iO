  ...
  return (
    <View style={eventStyles.eventPageContainer}>
      ...
      <View style={eventStyles.eventContentContainer}>
        ...
        <Pressable onPress={() => navigation.navigate('EventSchedule', { eventId: event.idEvent, eventTitle: event.title, eventColor: event.mainColorHex })} style={{ backgroundColor: event.mainColorHex || '#3B82F6', padding: 12, borderRadius: 8, alignItems: 'center', marginVertical: 10 }}>
