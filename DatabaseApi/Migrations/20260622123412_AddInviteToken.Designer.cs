...
namespace DatabaseApi.Migrations
{
    ...
    [Migration("20260622123412_AddInviteToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DatabaseApi.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseApi.Models.Poll", b =>
                {
                    b.Property<int>("IdPoll")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdPoll"));
            ...
            modelBuilder.Entity("DatabaseApi.Models.PollAnswer", b =>
                {
                    b.Property<int>("IdPollAnswer")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdPollAnswer"));
            ...
            modelBuilder.Entity("DatabaseApi.Models.PollVote", b =>
                {
                    b.Property<int>("IdPollVote")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IdPollVote"));
                    ...
                    b.HasIndex("IdPollAnswer");

                    b.HasIndex("IdUser", "IdPoll")
                        .IsUnique();
            ...
            modelBuilder.Entity("DatabaseApi.Models.Session", b =>
                {
                    ...
                    b.Property<DateTime?>("StartNotificationSendTime")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("StartTime")
                        .HasColumnType("datetime2");

                    b.Property<bool>("StartingNotificationSent")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DatabaseApi.Models.SessionReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DatabaseApi.Models.Notification", b =>
                {
                    b.HasOne("DatabaseApi.Models.User", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("DatabaseApi.Models.PollAnswer", b =>
                {
                    b.HasOne("DatabaseApi.Models.Poll", "Poll")
                        .WithMany("Answers")
            ...
            modelBuilder.Entity("DatabaseApi.Models.PollVote", b =>
                {
                    b.HasOne("DatabaseApi.Models.PollAnswer", "PollAnswer")
                        .WithMany("Votes")
                        .HasForeignKey("IdPollAnswer")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
